...
void AABCharacter::BeginPlay()
{
	...
	if (!IsPlayerControlled())
	{
		...
		if (nullptr != ABGameInstance)
		{
			...
			(CharacterAssetToLoad, FStreamableDelegate::CreateUObject(this, &AABCharacter
...
{
	USkeletalMesh* AssetLoad = Cast<USkeletalMesh>(AssetStreamingHandle->GetLoadedAsset());
	AssetStreamingHandle.Reset();
	if (nullptr != AssetLoad)
	{
		GetMesh()->SetSkeletalMesh(AssetLoad);
